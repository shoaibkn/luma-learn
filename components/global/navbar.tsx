...
const Navbar = () => {
  ...
  return (
    <nav className="gap-1 bg-accent m-4 rounded-full h-18 fixed bottom-0 left-0 right-0 shadow-xl flex flex-row p-4 justify-between items-center align-middle transition-colors duration-700">
      <Link href="/dashboard">
        <Button
          variant={"ghost"}
